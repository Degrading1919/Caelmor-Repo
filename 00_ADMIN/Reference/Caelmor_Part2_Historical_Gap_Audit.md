...
## Historical decision gate reviewed first

The Stage A contradiction register was reviewed before the Part 2 workers expanded history. The Director's earlier decisions give the necessary timing, identity, and succession direction for C01–C05, C07, C09–C10, and C13. Two remaining choices directly govern historical truth and were asked of the Creative Director before synthesis:

1. **C08 — “spirit” status.** The four regional elemental pattern conflicts with Lowmark's five-figure Founder origin and War History's “earth/spirit” phrase. Until the Director rules, the proposal describes Mire earth-memory but does not declare spirit either a fifth discipline or a metaphor. It also does not select a fifth Founder.
2. **C12 — postwar magic law.** War History's blanket ban cannot stand as an unqualified historical fact alongside Emberholt's public firecraft and the Director's Lowmark farm spells. Until the Director rules, the proposal describes civic practice and public fear but does not invent criminal penalties, licenses, tolerated exceptions, or an operative continent-wide ban.

The Director's answers should be recorded here and the dependent paragraphs in the two companion proposals revised **before** a canon-update recommendation is accepted. Those questions block the relevant ontology and legal history, not every independent historical proposal. No worker has silently chosen between their conflicting claims.
...
| First rediscoverers, Founders, four traditions | Contradictory / thin. | Partial: roles separated, four traditions given distinct trajectories. | **Developed as a framework** but roster and spirit ontology remain open C07–C08. No one is named or counted as a Founder and no Dreamer is placed in rediscovery. |
...
| Immediate recovery and modern institutions | Thin; aftermath spanned a stale century. | Partial: thirty-year periodization and regional service origins. | **Developed as proposal.** Local repair → legitimacy → managed memory → living disputes now has duties and evidence in every region. Legal magic history remains blocked by C12. |
...
## Unresolved Director decisions and scope boundaries
...
| **C08** | **Yes: magical ontology. Asked.** | Record Director's spirit ruling, then update tradition/Founder language consistently. |
| **C09** | Visibility and teaching of farm practice, especially with C12. | Preserve Director-set simple water farming and sole combat Field-Mage; decide local teaching norms during Part 3 after law is set. |
...
| **C12** | **Yes: postwar legal history. Asked.** | Record jurisdiction, start/end dates, and exceptions; then revise War History, timeline, and region references together. |
...
1. Record the two requested Director answers and later C03/C06/C07/C11/C14–C16 decisions in a claim-status ledger: directed truth, proposal, public belief, erroneous old line, or unresolved mystery.
...
3. Reconcile `LORE/Worldbuilding Docs/Caelmor_War_History.md` with the initiate Titan, Kaelith's freedom, the selected magic policy, and the new date, while preserving any useful war memory as explicitly marked in-world account.
...
| --- | --- | --- |
| **Lowmark: river, houses, and ordinary life** | Build several generations of flood/field work, Fenmere and rival charter authority, farm-water teaching, ferry households, Ashen Flats recovery, and a compact set of local side-story and environmental clue options. Trace at least one person/record to Thornfell and one to the Mire. Preserve a local resolution before any wider Hollow clue. | C12 legal policy and C09 social visibility first; Lowmark-only v1 budget. No player spell system, item/resource design, or automatic import of the old Seven Reaches Compact. |

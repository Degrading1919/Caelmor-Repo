...
6. **Cross-tier reuse strength — READY FOR CREATIVE DIRECTOR APPROVAL.** Recommend **selective layered reuse** from the current Lowmark material foundation rather than a target percentage from the legacy catalog. Processed construction, fuel, fitting, lining, and maintenance goods retain direct late demand when aspirational construction or repair physically consumes them. Source goods may remain indirectly relevant through legitimate conversion without being forced into late recipes. Ordinary wood retains direct civic and ordinary-market relevance plus indirect Smithing relevance through charcoal. This approach keeps early Hunting and woodland areas useful through dense source-to-process relationships while rejecting universal capstone inputs, prestige material tiers, and filler sinks. The supporting decision proposal identifies direct, indirect, repair, commission, and ordinary-market roles material by material.
...
**Next decision order:** (1) approve or revise the selective layered cross-tier reuse ruling; (2) decide the catalog-volume ceiling only after current foundation coverage and implementation burden are reviewed. Recalculate only after the relevant design choice, then playtest before promoting derived rates to runtime.
